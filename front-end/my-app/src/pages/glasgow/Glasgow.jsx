    ...
    return (
        <div className="glasgow-Container1">
            <div className="glasgow-imgContainer">
                ...
                <Logo src={"https://cdn-icons-png.flaticon.com/128/1828/1828778.png"} width={'20'}/>
                <Logo src="http://se.kmitl.ac.th/assets/logoglasgowuniversitysmall.png" width={'300'}/>
            </div>
            <div>
            ...
            <div className="glasgow-article">
                <article>
                    ...
                    <p>Requirement for the students who wish to join this double-degree program:</p>
                    <ul>
